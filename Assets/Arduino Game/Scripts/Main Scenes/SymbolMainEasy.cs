...
public class SymbolMainEasy : MonoBehaviour
{
    ...
    {
        if (prefab.name == "ButtonSymbolEasy") //If prefab string name equals corresponding symbol
        {
        ...
        else if (prefab.name == "SwitchSymbolEasy") //If prefab string name equals corresponding symbol
        {
        ...
        else if (prefab.name == "PhotoResistorSymbolEasy") //If prefab string name equals corresponding symbol
        {
            buttonCanvas.SetActive(false); //Set other symbols canvas to false
            switchCanvas.SetActive(false);
        ...
        else if (prefab.name == "AccelometerSymbolEasy") //If prefab string name equals corresponding symbol
        {
            buttonCanvas.SetActive(false); //Set other symbols canvas to false
            switchCanvas.SetActive(false);
            photoResistorCanvas.SetActive(false);
    ...
    public void LED()
    {
        if (prefab.name == "ButtonSymbolEasy" && canScore == true) //If prefab is ButtonSymbol and user hasnt scored
        {
        ...
        if (prefab.name == "SwitchSymbolEasy" && canScore == true) //If prefab is SwitchSymbol and user hasnt scored
        {
        ...
        if (prefab.name == "PhotoResistorSymbolEasy" && canScore == true) //If prefab is PhotoresistorSymbol and user hasnt scored
        {
        ...
        if (prefab.name == "AccelometerSymbolEasy" && canScore == true) //If prefab is AccelometerSymbol and user hasnt scored
        {
    ...
    IEnumerator Score()
    {
        ...
        if (prefab.name == "ButtonSymbolEasy" && buttonPressed == 0 && timeRemaining > 0 && canScore == true) //If prefab name equals certain prefab and the corresponding input is pressed and there is time remaining and can score is true
        {
        ...
        else if (prefab.name == "SwitchSymbolEasy" && switchFlipped == 0 && timeRemaining > 0 && canScore == true) //If prefab name equals certain prefab and the corresponding input is pressed and there is time remaining and can score is true
        {
            score++; //Increases score
        ...
        else if (prefab.name == "PhotoResistorSymbolEasy" && photoResistorValue <= 500 && timeRemaining > 0 && canScore == true) //If prefab name equals certain prefab and the corresponding input is pressed and there is time remaining and can score is true
        {
            score++; //Increases score
        ...
        else if (prefab.name == "AccelometerSymbolEasy" && accelometerValue <= 686 && timeRemaining > 0 && canScore == true) //If prefab name equals certain prefab and the corresponding input is pressed and there is time remaining and can score is true
        {
            score++; //Increases score
