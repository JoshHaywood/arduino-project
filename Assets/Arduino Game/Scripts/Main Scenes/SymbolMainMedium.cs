...
public class SymbolMainMedium : MonoBehaviour
{
    ...
    {
        if (prefab.name == "ButtonSymbolMedium") //If prefab string name equals corresponding symbol
        {
        ...
        else if (prefab.name == "SwitchSymbolMedium") //If prefab string name equals corresponding symbol
        {
        ...
        else if (prefab.name == "PhotoResistorSymbolMedium") //If prefab string name equals corresponding symbol
        {
            buttonCanvas.SetActive(false); //Set other symbols canvas to false
            switchCanvas.SetActive(false);
        ...
        else if (prefab.name == "AccelometerSymbolMedium") //If prefab string name equals corresponding symbol
        {
            buttonCanvas.SetActive(false); //Set other symbols canvas to false
            switchCanvas.SetActive(false);
            photoResistorCanvas.SetActive(false);
    ...
    public void LED()
    {
        if(prefab.name == "ButtonSymbolMedium" && canScore == true) //If prefab is ButtonSymbol and user hasnt scored
        {
        ...
        if (prefab.name == "SwitchSymbolMedium" && canScore == true) //If prefab is SwitchSymbol and user hasnt scored
        {
        ...
        if (prefab.name == "PhotoResistorSymbolMedium" && canScore == true) //If prefab is PhotoresistorSymbol and user hasnt scored
        {
        ...
        if (prefab.name == "AccelometerSymbolMedium" && canScore == true) //If prefab is AccelometerSymbol and user hasnt scored
        {
    ...
    IEnumerator Score()
    {
        ...
        if (prefab.name == "ButtonSymbolMedium" && buttonPressed == 0 && timeRemaining > 0 && canScore == true) //If prefab name equals certain prefab and the corresponding input is pressed and there is time remaining and can score is true
        {
        ...
        else if (prefab.name == "SwitchSymbolMedium" && switchFlipped == 0 && timeRemaining > 0 && canScore == true) //If prefab name equals certain prefab and the corresponding input is pressed and there is time remaining and can score is true
        {
            score++; //Increases score
        ...
        else if (prefab.name == "PhotoResistorSymbolMedium" && photoResistorValue <= 500 && timeRemaining > 0 && canScore == true) //If prefab name equals certain prefab and the corresponding input is pressed and there is time remaining and can score is true
        {
            score++; //Increases score
        ...
        else if (prefab.name == "AccelometerSymbolMedium" && accelometerValue <= 686 && timeRemaining > 0 && canScore == true) //If prefab name equals certain prefab and the corresponding input is pressed and there is time remaining and can score is true
        {
            score++; //Increases score
